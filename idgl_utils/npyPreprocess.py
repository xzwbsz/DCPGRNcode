...
# 3090
save_need_location = '/climatedata/haojy/21.3/data/'
...
load_allYear_location = '/public/141pres_npyData16-22/'
...
# 读取各年npy位置(不用更改)
featureNpy_everyYear_load_location = '/public/npydata/141pres_feature/feature_141pres_nodes_20*'
timeNpy_everyYear_load_location = '/public/npydata/141pres_time/time_141pres_nodes_20*'
